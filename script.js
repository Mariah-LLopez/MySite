...
(() => {
  ...
  const translations = {
    en: {
      ...
      'proj1.category': 'UX Strategy + Information Architecture',
      ...
      'proj5.category': 'AI Research + Technical Writing',
      'proj5.h3': 'AI-Augmented Workflow Report',
      'proj5.p': 'Evaluated AI writing and research tools and developed recommendations for responsible workplace adoption.',
      'proj5.tools': 'Tools: ChatGPT, Claude, Microsoft Copilot, Google Docs',
      ...
      'proj7.category': 'UX Research + Recommendations',
      'proj7.h3': 'UX Recommendation Report',
      'proj7.p': 'Analyzed usability challenges and produced recommendations to improve user experience and workflow efficiency.',
      'proj7.tools': 'Tools: UX Research, Analysis, Documentation',
      'proj7.link': 'View Work →',
      'proj8.category': 'Technical Documentation',
      'proj8.h3': 'SOP Markdown Template',
      'proj8.p': 'Created a reusable standard operating procedure template to improve documentation consistency and maintainability.',
      'proj8.tools': 'Tools: Markdown, Documentation Standards, SOP Design',
      'proj8.link': 'View Work →',
      'proj9.category': 'Healthcare Operations Analysis',
      'proj9.h3': 'Enterprise Healthcare Operations',
      'proj9.p': 'Analyzed healthcare operational workflows and documented opportunities for process improvement and organizational efficiency.',
      'proj9.tools': 'Tools: Process Analysis, Research, Documentation',
      ...
      'proj11.category': 'Business Analysis + Finance',
      'proj11.h3': 'Accounting Fundamentals',
      'proj11.p': 'Applied accounting principles and financial analysis concepts to support business decision-making.',
      'proj11.tools': 'Tools: Financial Analysis, Reporting, Business Fundamentals',
      ...
      'proj13.category': 'eLearning + Legal Information Design',
      'proj13.h3': 'Getting Organized for Legal Help',
      'proj13.p': 'Created a learning module that helps first-time legal clients prepare for consultations and gather key information.',
      'proj13.tools': 'Tools: Articulate 360, Instructional Design, Content Development',
      'proj13.link': 'View Work →',
      'proj14.category': 'Translation + Content Localization',
      'proj14.h3': 'Translation Documents',
      'proj14.p': 'Translated and adapted content to improve accessibility and communication for multilingual audiences.',
      'proj14.tools': 'Tools: Translation, Localization, Plain Language',
      'proj14.link': 'View Work →',
      'lab.h2': 'My Approach',
    ...
    es: {
      ...
      'proj1.category': 'Estrategia UX + Arquitectura de Información',
